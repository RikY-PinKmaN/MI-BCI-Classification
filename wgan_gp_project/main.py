        ...
        for subject_idx in range(num_subjects):
            ...
            try:
                ...
                x_train_wgan, y_train_wgan, finaltrn, finalval, finaltest = eeg_preprocess(
                    subject_data['x'], subject_data['y'], subject_id=subject_id, train_trials_per_class=None,val_trials_per_class=N_VAL_PER_CLASS, lowcut=LOWCUT, highcut=HIGHCUT, fs=FS, time_window_start=115, time_window_end_exclusive=615, label_left=1, label_right=2
                )
